    ...
    <footer className="bg-primary text-white pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Info */}
          <div>
            <h3 className="text-xl font-serif font-bold mb-4">Cozy Corner Cafe</h3>
            <p className="mb-4">Experience the perfect blend of comfort and taste in every cup.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/reservation" className="hover:text-secondary">Reservation</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span>123 Coffee Street, Brewtown, BT 98765</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span>info@cozycornercafe.com</span>
              </li>
              <li className="flex items-center">
                <svg className="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center">
          <p className="text-sm">© {new Date().getFullYear()} Cozy Corner Cafe. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
